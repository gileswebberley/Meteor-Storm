...
public class ScoringSystem : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("Create a TMPro text area for the score and place in your scene (ensure it is Enabled) - Enter the name of the object here")]
    ...
    //called from Scene Director by a button event
